...
public class MainActivity extends AppCompatActivity {
    mContentObserver mObserver;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_main);
        Uri uri = Uri.parse("content://scut.carson_ho.myprovider");

//         步骤1：注册内容观察者ContentObserver
        mObserver = new mContentObserver();
    ...
    private void delTest()
    {
        ...
        resolver.delete(uri_user, where, selectionArgs);
    ...
    class mContentObserver extends ContentObserver {
        ...
        public void onChange(final boolean selfChange) {
            ...
            System.out.println("Service ContentObserver received notification");
